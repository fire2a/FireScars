...
import re
import sys
#ejecución desde la linea de comandos para AS 
#python evaluation.py -ev1 "../datasets_csv_11_2023/val_test_97.csv" -ev2 "../datasets_csv_11_2023/bio_test_98.csv" -ms "AS" -mp "../modelos/ep25_lr1e-04_bs16_021__as_std_adam_f01_13_07_x3.model"

#ejecución desde la linea de comandos para 128 
#python evaluation.py -ev1 "../datasets_csv_11_2023/val_test_97.csv" -ev2 "../datasets_csv_11_2023/bio_test_98.csv" -ms "128" -mp "../modelos/ep25_lr1e-04_bs16_014_128_std_25_08_mult3_adam01.model"
def main(argv=None):
