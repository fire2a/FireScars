...
# evald1=pd.read_csv(Path("path/Dataset1/evaluation"))
# evald2=pd.read_csv(Path("path/Dataset2/evaluation"))
...
def evaluation(model_size):
    ...
    for i, batch in progress:
        ...
        all_accs.extend([accuracy_score(y_bin, prediction)])
