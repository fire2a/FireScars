...
from parameters import dataset1_training_path, dataset2_training_path, dataset1_validation_path, dataset2_validation_path, model_128_path
from parameters import dataset1_Firescar_tif_128_paths, dataset1_PostFire_tif_128_paths, dataset1_PreFire_tif_128_paths, dataset2_Firescar_tif_128_paths, dataset2_PostFire_tif_128_paths, dataset2_PreFire_tif_128_paths   
import pandas as pd
...
class firescardataset():
    def __init__(self, dataset, ss1, ss2, ss3, ss4, mult=1, transform=None):
        ...
        for i in range(ss1,ss2):
            self.seglabels.append(os.path.join(dataset1_Firescar_tif_128_paths, dataset.loc[i,"FireScar_tif"]))
            self.imgfiles.append(os.path.join(dataset1_PostFire_tif_128_paths,dataset.loc[i,"ImgPosF"]))
            self.imgprefiles.append(os.path.join(dataset1_PreFire_tif_128_paths,dataset.loc[i,"ImgPreF"]))

        for i in range(ss3,ss4):
            self.seglabels.append(os.path.join(dataset2_Firescar_tif_128_paths,dataset.loc[i,"FireScar_tif"]))
            self.imgfiles.append(os.path.join(dataset2_PostFire_tif_128_paths,dataset.loc[i,"ImgPosF"]))
            self.imgprefiles.append(os.path.join(dataset2_PreFire_tif_128_paths,dataset.loc[i,"ImgPreF"]))
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(model_128_path, map_location=torch.device('cpu')))
