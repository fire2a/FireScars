...
# data_train1=pd.read_csv(Path("../path/Dataset1/Dataset128"))
# data_train2=pd.DataFrame()
# data_val1=pd.read_csv(Path("../path/Dataset1/Dataset128"))
# data_val2=pd.DataFrame()

# if there are two datasets to analyze

# data_train1=pd.read_csv(Path("path/Dataset1/Dataset128"))
# datas_train2=pd.read_csv(Path("path/Dataset2/Dataset128"))  
# data_train=pd.concat([data_train1,data_train2], axis=0, ignore_index=True)

# data_val1=pd.read_csv(Path("path/Dataset1/Dataset128"))
# datas_val2=pd.read_csv(Path("path/Dataset2/Dataset128"))  
